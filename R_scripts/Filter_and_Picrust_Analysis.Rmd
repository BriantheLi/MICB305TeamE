...
combined_venn_core_microbiome = ggVennDiagram(
      list(ASVs_healthy, ASVs_crohn_disease, ASVs_ulcerative_colitis, ASVs_low_alcohol_intake, ASVs_high_alcohol_intake),
      set_size = 3,
      category.names = c("Healthy", "CD", "UC", "low_alcohol", "high_alcohol")) +
      theme(text = element_text(size = 12)) +
      scale_fill_gradientn( colors = c(low = "#99D48B", high = "#FFCC9E"))
combined_venn_core_microbiome
# Maybe save this in the Figures folder inside of the Results folder
# ggsave(
#   filename = "combined_venn_core_microbiome.jpeg",
#   plot = combined_venn_core_microbiome,
#   path = "../R_scripts",                
#   width = 10,
#   height = 10)
```
