...
alcohol_venn_core_microbiome = ggVennDiagram(list(ASVs_low_alcohol_intake, ASVs_high_alcohol_intake),
      			  set_size = 5,
...
ibd_venn_core_microbiome = ggVennDiagram(list(ASVs_healthy, ASVs_crohn_disease, ASVs_ulcerative_colitis),
      			  set_size = 4,
...
combined_venn_core_microbiome = ggVennDiagram(list(ASVs_healthy, ASVs_crohn_disease, ASVs_ulcerative_colitis, ASVs_low_alcohol_intake, ASVs_high_alcohol_intake),
      			  set_size = 3,
